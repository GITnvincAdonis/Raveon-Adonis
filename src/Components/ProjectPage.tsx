...
export default function ProjectPage() {
  ...
  const animationParameters = [
    ...
    ["0", "60vh", 1, 3, "render 1"],
    ["0", "70vh", 1, 3, "render 2"],
    ["-0", "-50vw", 1, 3, "Internal Assessment-game"],
    ["80vw", "0vw", 2, 1, "Water Sim"],
  ];
      ...
      >
        <motion.div className="grid-container">
          {animationParameters.map((item, index) => {
            const classes =
              "project-container project-container-" + (index + 1);

            let cachedScaleX;
            let cacchedScaleY;
            let displaceCSSValueX;
            let displaceCSSValueY;
            if (getWindowDimensions().width > 700) {
              cachedScaleX = item[2];
              cacchedScaleY = item[3];
              displaceCSSValueX = item[0];
              displaceCSSValueY = item[1];
            } else {
              cachedScaleX = 1;
              cacchedScaleY = 1;
              displaceCSSValueX = "0vw";
              displaceCSSValueY = "0vw";
            }

            const [delayMult, updateDelay] = useState(1);
            useEffect(() => {
              setTimeout(() => {
                console.log(0);
                updateDelay(0);
          ...
          <motion.div className=" project-container-6">
            <div className="innr-border"></div>
          </motion.div>
          <motion.div className="d-flex justify-content-evenly project-container-7">
            <Link
              to="https://github.com/GITnvincAdonis"
            ...
            <Link
              to="#"
              onClick={(e) => {
                window.location.href = "mailto:rav30nad0nis@example.com";
                e.preventDefault();
              }}
              className="github-icon"
            >
